...
import { IoLink, IoHeartCircleOutline, IoStar } from "react-icons/io5";

async function getPlaceDetails(type, placeId) {
  return {
    rating: "",
  };
}
